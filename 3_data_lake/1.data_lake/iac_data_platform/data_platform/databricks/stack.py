...
class DatabricksStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, **kwargs) -> None:
        ...
        cross_account_policy = iam.Policy(
            ...
            statements=[
                ...
                iam.PolicyStatement(
                    ...
                    resources=[
                        f"arn:aws:s3:::s3-name-here-{self.deploy_env.value}-data-lake-*",
        ...
        bucket = s3.Bucket(
            self,
            id=f"s3-{self.deploy_env.value}-name-here-databricks-bucket",
            bucket_name=f"s3-{self.deploy_env.value}-name-here-databricks-bucket",
        )
